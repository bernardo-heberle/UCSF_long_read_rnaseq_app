...
@callback(
    [Output("tab6-container", "style"),
     Output("tab6-header", "style"),
     Output("tab6-content", "style"),
     Output("tab6-card", "style")],
    [Input("window-dimensions", "data")]
)
def update_tab6_responsiveness(dimensions):
    if not dimensions:
